          ...
          <div className="landing-container">
            ...
            <div className="landing-feature-grid">
              ...
              <article className="landing-feature-card">
                ...
                <p>
                  Find available doctors, choose a convenient time,
              ...
              <article className="landing-feature-card">
                ...
                <p>
                  Follow your position in the queue and know when
              ...
              <article className="landing-feature-card">
                ...
                <p>
                  Keep appointments, patient information, and queue
                  activity organized in one experience.
                </p>
              ...
              <article className="landing-feature-card">
                ...
                <p>
                  Build toward smarter healthcare operations with
        ...
        >
          ...
          <div className="landing-container">
            ...
            <div className="landing-section-heading landing-heading-centered">
              ...
              <h2>
                A simpler journey for every patient.
              </h2>

              <p>
                Smart Health connects patients and healthcare providers
                through a straightforward digital workflow.
              </p>
            ...
            <div className="landing-steps">
              ...
              <div className="landing-step">
                ...
                <div>
                  ...
                  <p>
                    Discover doctors and available appointment times.
                  </p>
                </div>
              ...
              <div className="landing-step">
                ...
                <div>
                  ...
                  <p>
                    Choose a convenient time and submit your appointment.
                  </p>
                </div>
              ...
              <div className="landing-step">
                ...
                <div>
                  ...
                  <p>
                    Follow your queue position while you wait.
                  </p>
                </div>
              ...
              <div className="landing-step">
                ...
                <div>
                  ...
                  <p>
                    Arrive prepared and follow the consultation workflow.
                  </p>
                </div>
          ...
          <div className="landing-container">
            ...
            <div className="landing-ai-card">
              ...
              <div className="landing-ai-content">
                ...
                <p>
                  A future AI feature will use historical appointment
                  and queue data to help estimate waiting times more
                  intelligently.
                </p>
      ...
      <footer className="landing-footer">
        ...
        <div className="landing-container landing-footer-inner">
          ...
          <div className="landing-footer-copy">
            © {today.getFullYear()} Smart Health
          </div>
